...
//        this.mTxtEmptyListBahan = (TextView) view.findViewById(R.id.table);
    ...
    public void onAttach(Activity activity){
        ...
        ((PilihBahan)context).fragmentCommunicator3 = this;
    }
    ...
    public void passDataToFragment(String haha){
        ...
        if(haha.toString().equals("protein")){
            ...
            if(bahanid.equals("")) {
                ...
                Toast.makeText(getActivity(), "Bahan sumber protein tidak boleh kosong", Toast.LENGTH_SHORT).show();
    ...
    public static class RecyclerTouchListener implements RecyclerView.OnItemTouchListener {
        ...
        private BahanProtein.ClickListener clickListener;

        public RecyclerTouchListener(Context context, final RecyclerView recyclerView, final BahanProtein.ClickListener clickListener) {
